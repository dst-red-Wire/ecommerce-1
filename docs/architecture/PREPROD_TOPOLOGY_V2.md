...
All VMs use the locked Rocky Linux 10.2 Packer base image, SELinux Enforcing, nftables where applicable, chrony, Wazuh agent and OpenTelemetry Collector where the role requires host or infrastructure telemetry.
