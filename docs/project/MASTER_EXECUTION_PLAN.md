...
### M2.5 — Persistent MGMT Bootstrap IaC

Canonical tracker: GitHub issue `#32`.

Create and prove the persistent management plane from the existing inventory and deployment contracts. It is a prerequisite for real PREPROD `CREATE`, not a competing PREPROD environment.
