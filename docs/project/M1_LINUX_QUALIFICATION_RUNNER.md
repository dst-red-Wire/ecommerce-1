...
Supply a clean Ubuntu 24.04 VM with systemd, SSH/root escalation, outbound access to the
Ubuntu package repositories, and a non-root qualification account. Copy
...
The role installs and holds exact package versions, enables Docker across reboot, grants
