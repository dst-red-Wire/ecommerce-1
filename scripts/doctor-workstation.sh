...
for cmd in git make python3 pipx pre-commit ansible ansible-lint molecule terraform tflint trivy checkov gitleaks ggshield semgrep syft cosign kubeconform conftest opa kubectl helm kustomize docker; do
