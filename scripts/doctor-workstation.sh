...
for cmd in git make go gofmt python3 pipx pre-commit ansible ansible-lint molecule terraform tflint trivy checkov gitleaks ggshield semgrep syft cosign rg fd yq ast-grep kubeconform conftest opa kubectl helm kustomize docker; do
