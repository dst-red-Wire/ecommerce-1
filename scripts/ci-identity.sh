...
require jq
catalog=tests/security/identity-scenarios.json
[ -f "$catalog" ] || fail "missing identity scenario catalog: $catalog"
...
info "identity scenario definitions validated; no attack traffic was generated"
