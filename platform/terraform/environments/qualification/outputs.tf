...
output "qualification_gateway_inventory_host_line" {
  ...
  value       = "gateway ansible_host=${module.hcloud_qualification.gateway_ipv4} ansible_user=${module.hcloud_qualification.gateway_user} qualification_gateway_user=${module.hcloud_qualification.gateway_user} qualification_runner_private_ip=${module.hcloud_qualification.runner_private_ip} qualification_squid_version=${var.qualification_squid_version} qualification_ubuntu_snapshot=${var.qualification_ubuntu_snapshot}"
}
