...
output "qualification_inventory_host_line" {
  ...
  value       = "qualification ansible_host=${module.hcloud_qualification.ipv4} ansible_user=${module.hcloud_qualification.user} qualification_user=${module.hcloud_qualification.user}"
}
